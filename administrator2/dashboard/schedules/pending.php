                  ...
                  <tr>
                    ...
                    <td>
                      ...
                      <button 
                            ...
                            data-1st="<?= $sched['1ST_REQUIREMENT']; ?>" 
                            data-2nd="<?= $sched['2ND_REQUIREMENT']; ?>" 
                            data-event="<?= $sched['EVENT_DATE']; ?>" 
                            data-toggle="modal" 
                            <?= $sched['sched_status'] == 1 ? 'disabled' : ''; ?>>
                            Approve
                          </button>
                      </td>
                  </tr>
...
include('modal/approveModal.php');
  ?>
...
<script src="../livestock2/administrator2/dashboard/schedules/sched.js"></script>
<script>
