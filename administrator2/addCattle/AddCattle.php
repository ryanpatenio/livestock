...
<div class="modal fade" id="AddCattleModal" tabindex="-1" aria-labelledby="AddCattleModalLabel" aria-hidden="true">
  <div class="modal-dialog modal-lg">
    <div class="modal-content">
      ...
      <form action="" method="POST" enctype="multipart/form-data" id="addCattleForm">
...
<script src="../livestock2/administrator2/addCattle/cattle.js"></script>
...
function searchClient() {
  ...
  if (searchValue.length > 0) {
    ...
    xhr.open("POST", "administrator2/addcattle/search_client.php", true);
