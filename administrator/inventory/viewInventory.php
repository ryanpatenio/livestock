                ...
                <div class="col-md-12">
                    <div class="card shadow-sm">
                        ...
                        <div class="row">
                            ...
                            <div class="col-6">
                                    <button class="btn btn-primary float-right" data-toggle="modal" data-target="">Generate Report</button> 
                            </div>                     
                        </div>
            ...
            <div class="col-md-12 mt-5">
                    <div class="card shadow-sm">
                        ...
                        <div class="row">
                            ...
                            <div class="col-6">
                                    <button class="btn btn-success float-right" data-toggle="modal" data-target="">Generate Report</button> 
                            </div>                     
                        </div>
