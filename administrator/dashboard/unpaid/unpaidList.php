...
$clientQuery = "SELECT c.CLIENT_ID, CONCAT(FNAME, ' ', LNAME) AS full_name  from dispersal d, client c where d.CLIENT_ID = c.CLIENT_ID and d.1ST_PAYMENT_ID = 0 and d.2ND_PAYMENT_ID = 0 ORDER BY c.FNAME ASC";
$clientUnpaidResult = mysqli_query($con, $clientQuery);
$clientsUnpaid = mysqli_fetch_all($clientUnpaidResult, MYSQLI_ASSOC);
  ...
  <div class="content-header" style="margin-top: -20px;">
    <div class="container-fluid">
      <div class="row mb-1 align-items-center">
        <div class="col-sm-6">
          <h1 class="m-0 text-primary"><i class="fas fa-users"></i> Dispersal Records --Unpaid Clients</h1>
        </div>
        <div class="col-sm-6">
        ...
        <div class="col-md-6 mb-4">
          <div class="card shadow-sm">
              <div class="card-header bg-primary text-white">
                  <h6 class="mb-0"><b>List of Unpaid Clients</b></h6>
              </div>
              <div class="card-body">
...
<script src="../livestock2/administrator2/dashboard/unpaid/unpaid.js"></script>
<script>
