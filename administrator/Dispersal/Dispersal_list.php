...
$Query2 = "SELECT ANIMAL_ID, c.category_id,c.category_name as ANIMALTYPE, ANIMAL_SEX FROM animal a,category c WHERE a.category_id = c.category_id AND CLIENT_ID = ? AND ANIMAL_SEX = 'Female'";
