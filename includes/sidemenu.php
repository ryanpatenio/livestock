  ...
  <aside class="main-sidebar sidebar-dark-primary elevation-3" id="mySidebar">
    ...
    <div class="sidebar">
      ...
      <div class="user-panel mt-3 pb-3 mb-3 d-flex">
        ...
        <div class="info">
          <a href="#"role="btn" class="d-block" data-toggle="modal" data-target="#logoutAdminModal">Staff<?php //echo $_SESSION['FULLNAME'] ?></a>
        </div>
      </div>
      ...
      <nav class="mt-2">
        <ul class="nav nav-pills nav-sidebar flex-column sidemenus" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item" >
            <a href="index.php?page=dashboard" class="nav-link <?= $dashboard?>">
          ...
          <li class="nav-item">
            <a href="index.php?page=Clientlist" class="nav-link <?= $clientlist?>">
              <i class="nav-icon fas fa-users"></i>
              <p>Client  </p>
            </a>
          </li>
          <li class="nav-item">
            <a href="index.php?page=Dispersal"  class="nav-link <?= $Dispersal?>">
          ...
          <li class="nav-item">
            <a href="index.php?page=Recording"  class="nav-link <?= $Recording?>">
          ...
          <li class="nav-item">
            <a href="index.php?page=inventory" class="nav-link <?= $inventory?>">
              <i class="nav-icon fas fa-file"></i>
              <p>Inventory </p>
            </a>
          </li>
          <li class="nav-item">
            <a href="index.php?page=Schedule" class="nav-link <?= $Schedule?>">
              <i class="nav-icon fas fa-file"></i>
              <p>Schedule </p>
            </a>
          </li>
